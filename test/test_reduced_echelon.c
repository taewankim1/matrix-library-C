...
int main() {
    ...
    Matrix* b1 = reduced_row_echelon_form(a1);
    Matrix* b2 = reduced_row_echelon_form(a2);
    Matrix* b3 = reduced_row_echelon_form(a3);
    Matrix* b4 = reduced_row_echelon_form(a4);
    Matrix* b5 = reduced_row_echelon_form(a5);
